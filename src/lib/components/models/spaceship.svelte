...
Command: npx @threlte/gltf@2.0.1 C:\Users\yousu\threejs_journey\challenges\solar-system\spaceship-animation\static\models\spaceship.glb --root /models/ --printwidth 120 --precision 2
...
<script>
  import { AddEquation, CustomBlending, CylinderGeometry, Group, MeshBasicMaterial, OneFactor } from 'three'
